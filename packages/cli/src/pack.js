...
import { assertValidManifest, validateManifest } from "@wubbleai/manifest";
...
/** @param {string} target @param {Awaited<ReturnType<typeof validatePack>>} report @param {import("@wubbleai/manifest").FeedbackManifest} exportedManifest @param {"web" | "react-native"} platform */
...
/** @param {string} target @param {Awaited<ReturnType<typeof validatePack>>} report @param {import("@wubbleai/manifest").FeedbackManifest} exportedManifest */
...
/** @param {import("@wubbleai/manifest").FeedbackAsset} asset */
...
/** @param {import("@wubbleai/manifest").FeedbackAssetVariant} asset */
...
/** @param {string} eventName @param {import("@wubbleai/manifest").FeedbackAsset} asset */
...
/** @param {string} target @param {import("@wubbleai/manifest").FeedbackManifest} manifest @param {{ source?: string, contents?: string, target: string }[]} writes @param {"web" | "react-native"} platform */
...
/** @param {string} sourceDirectory @param {import("@wubbleai/manifest").FeedbackAssetVariant} asset @param {string} label @param {string[]} errors */
...
/** @param {import("@wubbleai/manifest").FeedbackManifest} manifest @param {string} integrationPath @param {string} assetDirectory */
...
/** @param {import("@wubbleai/manifest").FeedbackManifest} manifest @param {number} budgetKb @param {"web" | "react-native"} platform */
...
/** @param {import("@wubbleai/manifest").FeedbackManifest} manifest @param {string} eventName @param {number | null} variantIndex */
